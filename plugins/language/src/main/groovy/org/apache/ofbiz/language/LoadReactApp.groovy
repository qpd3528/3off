...
// Useful variables with language values:
// controlPath ->= /language/control
// contextRoot -> C:\dev\floss\ofbiz\ofbiz-framework\plugins\language\webapp\language\
// serverRoot -> https://localhost:8443
// context.application.context.context.path -> /language

// Path component of URL leading to the servlet mount point, e.g. '/language'.
String contextUrlPath = context.application.context.context.path
// Filesystem path to the webapp root, e.g. '$ofbiz-framework/plugins/language/webapp/language/'.
